...
class MyModel extends AbstractTableModel{
        ...
        public Object getValueAt(int rowIndex, int columnIndex){
            switch(columnIndex){
                case 0: return (classe.getListEleve().get(rowIndex).getIdEleve());
                case 1: return (classe.getListEleve().get(rowIndex).getPrenomEleve());
                case 2: return (classe.getListEleve().get(rowIndex).getNomEleve());
